...
The full component-side explanation, including manual `het:sync` dispatch for non-request DOM updates, is covered in the [components tutorial](tutorial-components.md#acquire-state-from-the-dom-with-seed-and-sync).
